    ...
    <div className="relative min-h-[calc(100vh-64px)] flex flex-col items-center justify-center overflow-hidden w-full pt-16">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 flex flex-col items-center text-center">
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card-ultra border border-white/10 mb-8"
        >
        ...
        >
          <button
            ...
            className="group relative px-8 py-4 btn-primary text-lg flex items-center justify-center gap-3"
          >
          ...
          <button
            ...
            className="px-8 py-4 btn-secondary text-lg flex items-center justify-center gap-3"
          >
        ...
        >
          {[
            ...
            <div key={i} className="p-6 rounded-3xl glass-card-ultra border border-white/5 card-hover group">
              <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform group-hover:bg-indigo-500/20 glow-ring">
